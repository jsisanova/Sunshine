...
// We want our AsyncTaskLoader to return an array of strings
public class MainActivity extends AppCompatActivity implements ForecastAdapterOnClickHandler, LoaderManager.LoaderCallbacks<String[]> {
    ...
    // This number will uniquely identify our Loader, you can change this to any number you like, as long as you use the same variable name.
   ...
   /* private void loadWeatherData() {
     ...
     * clicks.
     *
     * @param weatherForDay String describing weather details for a particular day that was clicked
     */
    @Override
