...
//      TODO (5) Check to see if our weather ContentProvider is empty
         ...
         */
//        To check if the ContentProvider is empty, simply run a query and get the result count, but do so on a background thread using an AsyncTask
        new AsyncTask<Void, Void, Void>() {
            ...
            public Void doInBackground( Void... voids ) {
                 ...
                 * row.
                 * In our queries where we display data, we need to PROJECT more columns
